...
public class TestLeadsPage extends SeleniumUtility{
	...
	public void testLeadModification() {
		getVtigerLeadsPage.EditCompanyname("J&J");
		Assert.assertTrue(getVtigerLeadsPage.LeadModification(), "Company not added");
		
	}
	
	@Test(dependsOnMethods="testLeadModification")
