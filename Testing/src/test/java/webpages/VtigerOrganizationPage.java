...
public class VtigerOrganizationPage extends SeleniumUtility {
	...
	public VtigerOrganizationPage(WebDriver driver) {
	  ...
	  @FindBy(css="#appnavigator")
			...
			@FindBy(xpath = "//div[@id='mCSB_1_container']//li[4]/a")
	...
	@FindBy(xpath = "//a[@class='urlField cursorPointer']")
	...
	public boolean OrganizationModification() {
		return isElementExist(editWebsite);
	}
